    ...
    <main class="flex-1 overflow-y-auto bg-slate-50 relative">
      ...
      <header class="sticky top-0 z-10 glass border-b border-white/20">
        <div class="px-8 py-4 flex justify-between items-center">
          <div>
            <h2 class="text-2xl font-bold text-slate-800">@yield('title', 'Dashboard')</h2>
            <p class="text-sm text-slate-500">@yield('subtitle', 'Selamat datang kembali, ' . Auth::user()->name)</p>
          </div>
